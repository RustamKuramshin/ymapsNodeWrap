...
async function openPage() {
    const current = await puppeteer.launch({
        // Облегчённый chrome-headless-shell: интерфейс браузера сервису не нужен.
        headless: 'shell',
        // /dev/shm в контейнере по умолчанию всего 64 МБ.
...
module.exports = { getPage, getRouteLength, isReady, close };
